...
const expirationDateMasked = IMask(expirationDate, expirationDatePettern)
...
cardHolder.addEventListener("input", () => {
    ...
    ccHolder.innerText = cardHolder.value == "" ? "FULANO DE TAL" : cardHolder.value
})
...
function updateSecurityCode(code) {
    ...
    ccSecurityCode.innerText = code == "" ? "123" : code
}
...
function updateCardNumber(number) {
    ...
    ccCardNumber.innerText = number == "" ? "1234 5678 9012 3456" : number
}
...
function updateExpirationDate(date) {
    ...
    ccExpirationDate.innerText = date == "" ? "01/32" : date
}